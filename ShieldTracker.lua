...
function ArcHUD:EnableShieldTracking()
	if self.enable then
		return
	end

	-- Register the events we will use
	ArcHUD:RegisterEvent("UNIT_CASTEVENT", "CastEvent")
	ArcHUD:RegisterEvent("CHAT_MSG_SPELL_AURA_GONE_SELF", "AuraFadeEvent")
	ArcHUD:RegisterEvent("CHAT_MSG_COMBAT_CREATURE_VS_SELF_HITS", "DamageEvent")
	ArcHUD:RegisterEvent("CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE", "DamageEvent")
	ArcHUD:RegisterEvent("CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE", "DamageEvent")

    ArcHUD:RegisterEvent("CHAT_MSG_SPELL_HOSTILEPLAYER_DAMAGE", "SelfDamageEvent")
    ArcHUD:RegisterEvent("CHAT_MSG_COMBAT_HOSTILEPLAYER_HITS", "SelfDamageEvent")

	ArcHUD:RegisterEvent("CHAT_MSG_SPELL_SELF_DAMAGE", "SelfDamageEvent") -- self is only the target for spells that hurt yourself

	ArcHUD:RegisterEvent("PLAYER_DEAD", "DeathEvent")

	self.enable = true
end

function ArcHUD:CastEvent(caster, target, event, spellID, castDuration)
	...
	ArcHUD:TriggerEvent("ArcHUD_SHIELD_UPDATE")
end

function ArcHUD:AuraFadeEvent()
...
function ArcHUD:ParseElementalAbsorbAmount(eventStr)
...
function ArcHUD:ParseAbsorbAmount(eventStr)
...
function ArcHUD:DeductShield(dmgType, amt)
...
function ArcHUD:SelfDamageEvent()
	...
	return ArcHUD:DamageEvent(arg1)
end

function ArcHUD:DamageEvent()
