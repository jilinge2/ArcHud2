...
local module = ArcHUD:NewModule("ShieldIceBarrier")
...
function module:Initialize()
	...
	self.ShieldText = self:CreateFontString(self.f, "BACKGROUND", { 150, 15 }, 14, "RIGHT", { 1.0, 1.0, 0.0 }, { "TOPRIGHT", ArcHUDFrameCombo, "TOPLEFT", 0, -35 })
...
function module:Enable()
	...
	self:RegisterEvent("ArcHUD_SHIELD_UPDATE", "UpdateShield")
