...
local module = ArcHUD:NewModule("ShieldMana")
...
function module:Initialize()
	...
	self.ShieldText = self:CreateFontString(self.f, "BACKGROUND", { 150, 15 }, 14, "LEFT", { 1.0, 1.0, 0.0 }, { "TOPLEFT", ArcHUDFrameCombo, "TOPRIGHT", 0, -35 })
