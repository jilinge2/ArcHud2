...
local module = ArcHUD:NewModule("ShieldCombined")
...
function module:Initialize()
	...
	self.ShieldText = self:CreateFontString(self.f, "BACKGROUND", { 150, 15 }, 14, "CENTER", { 1.0, 1.0, 0.0 }, { "TOP", ArcHUDFrameCombo, "TOP", 0, -35})
